...
# Based on: https://docs.cloud.google.com/vpc-service-controls/docs/supported-method-restrictions
# NOTE: Only these 10 services support method restrictions in VPC SC:
# 1. Artifact Registry, 2. BigQuery, 3. Cloud Resource Manager, 4. Compute Engine
# 5. Container Registry, 6. IAM, 7. Cloud Logging, 8. Cloud Pub/Sub, 9. Cloud Run, 10. Cloud Storage
#
# Services NOT supported: Cloud SQL, Dataflow, Spanner, Firestore, etc.
# For unsupported services, use "*" (all methods)
...
SUPPORTED_VPC_SC_METHODS = {
    ...
    "bigquery.models.updateIamPolicy",
    "bigquery.models.getIamPolicy",
    ...
    "cloudresourcemanager.tagKeys.update",
    ...
    "cloudresourcemanager.tagValues.update",
    ...
    "containerregistry.images.create",
    "containerregistry.images.delete",
    "containerregistry.images.get",
    "containerregistry.images.list",
    "containerregistry.images.update",
    ...
    "logging.logs.delete",
    "logging.logs.list",
    "logging.logBuckets.create",
    "logging.logBuckets.delete",
    "logging.logBuckets.get",
    "logging.logBuckets.list",
    "logging.logBuckets.update",
    "logging.logSinks.create",
    "logging.logSinks.delete",
    "logging.logSinks.get",
    "logging.logSinks.list",
    "logging.logSinks.update",
